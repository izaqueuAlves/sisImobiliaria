...
public class Tela_Editar_Imovel extends javax.swing.JFrame {

    public Tela_Editar_Imovel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("EDITAR IMÓVEL");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Editar_Imovel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Editar_Imovel().setVisible(true);
            }
        });
    }
